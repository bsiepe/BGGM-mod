...
# Introduction
This is a follow-up to the vignette ["Three Ways to Test the Same Hypothesis"](https://donaldrwilliams.github.io/BGGMmod/articles/hyp_3_ways.html). A
new feature, `pcor_sum`, was added to **BGGMmod** that allows for testing partial correlation sums. 
...
# Two Groups
This next example is for two groups. The data are called `bfi` and they are in the **BGGMmod** package. I compare a sum of two relations for questions measuring agreeableness in males and females. The relations tested are as follows
...
[github](https://github.com/donaldRwilliams/BGGMmod/issues) or [BGGMmod-users group](https://groups.google.com/forum/#!forum/bggm-users).
