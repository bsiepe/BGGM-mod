...
called `roll_your_own` and it was suggested by a user of **BGGMmod**  ([see feature request here](https://github.com/donaldRwilliams/BGGMmod/issues/12)).
...
In **BGGMmod**, this implemented with `type = mixed` which is kind of a misnomer because the data do not 
